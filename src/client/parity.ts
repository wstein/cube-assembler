...
// with the stickers to point at when a check fails. Runs in the browser,
// so the check also works on the static GitHub Pages site. The orientation
// search keeps its own faster mirror of these rules - see
// cubeAssembly.ts's isFullyValid.
